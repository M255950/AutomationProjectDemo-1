...
//	private WebElement buyBtn;
	...
	@FindBy(xpath = "//div[text()='Terms & Conditions']")
	private WebElement termAndConBtn;
	...
	public TermsAndConditionsPage clickOnTermsPage() {
		js.executeScript("arguments[0].click();", termAndConBtn);
		//termAndConBtn.click();
